        ...
        >
           ...
           <Tab.Screen 
                ...
                options={{ 
                    ...
                    // Add this to force the screen to unmount and remount when tab is pressed
                    unmountOnBlur: true
                }} 
                listeners={({ navigation }) => ({
                    tabPress: e => {
                        ...
                        e.preventDefault();
                        // Reset the screen params to force a refresh
                        navigation.navigate('History', { refresh: Date.now() });
                    },
                })}
            />
           <Tab.Screen 
