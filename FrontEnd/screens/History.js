...
const History = ({ navigation }) => {
    ...
    const renderPagination = () => {
        ...
        if (historyData.length === 0 || totalPages <= 1) return null;
        ...
        return (
            <View style={styles.paginationContainer}>
                ...
                <TouchableOpacity 
                    ...
                    activeOpacity={0.7}
                >
                    <Text style={[styles.pageButtonText, isLastPage && styles.disabledButtonText]}>Next</Text>
                    <Icon name="chevron-right" size={20} color={isLastPage ? "#aaa" : "#fff"} />
                </TouchableOpacity>
            </View>
        );
    };
