...
const getBaseUrl = () => {
    ...
    if (Platform.OS === 'ios') {
        ...
        return 'http://localhost:3000'; // Change to your IP when testing on real device
    }
    
    // For Xiaomi HyperOS devices, use the actual IP address instead of 10.0.2.2
    if (isXiaomiHyperOS) {
        return 'http://192.168.1.100:3000'; // Replace with your actual computer's IP address
    }
    
    return 'http://10.0.2.2:3000'; // Standard Android emulator IP
};
